...
# =============================================================================
# WAY 15: Layer-based with explicit farthest tracking
# =============================================================================
def jump_15(nums):
...
# =============================================================================
# WAY 17: DP - sweep with early exit
# =============================================================================
def jump_17(nums):
    """For each i, sweep forward to update min jumps. Early exit when end reached."""
    n = len(nums)
    if n <= 1:
        return 0
    dp = [float("inf")] * n
